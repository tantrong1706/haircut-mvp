...
test("chỉ QR salon nhận context Testing Version 19", () => {
  ...
  assert.equal(result.searchParams.get("version"), "19");
});
...
test("QR salon ghi đè context cũ thay vì thêm trùng", () => {
  ...
  assert.deepEqual(result.searchParams.getAll("version"), ["19"]);
});
