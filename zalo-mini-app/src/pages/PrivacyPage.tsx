    ...
    <section className="privacy-page">
      ...
      <div className="panel privacy-content">
        ...
        <p>
          ...
          thoại Zalo. Hệ thống còn xử lý salon, chi nhánh và thời điểm check-in; điểm, lịch sử cắt
          tóc, ghi chú dịch vụ, lượt quay và mã quà. Với chủ salon và nhân viên, hệ thống lưu email
          đăng nhập, tên, vai trò và chi nhánh được phân công.
        </p>

        <h2>3. Ảnh kiểu tóc và sự đồng ý</h2>
        <p>
          Trước nút Yêu cầu tích điểm, ứng dụng thông báo việc chụp và lưu ảnh kiểu tóc của lần phục
          vụ này. Khi bấm nút, khách đồng ý để nhân viên tại chi nhánh chụp và lưu tối đa 3 ảnh vào
          lịch sử lần cắt. Ảnh không bắt buộc để nhân viên xác nhận điểm. Khách có thể yêu cầu salon
          dừng chụp hoặc yêu cầu xóa ảnh theo mục 8.
        </p>

        <h2>4. Mục đích sử dụng</h2>
        <p>
          Dữ liệu chỉ được dùng để xác nhận khách tại đúng chi nhánh, ghi nhận lần phục vụ, hỗ trợ
          salon phục vụ đúng nhu cầu, cộng điểm, quay thưởng, đổi quà, xử lý yêu cầu hỗ trợ và bảo
          vệ hệ thống trước hành vi lạm dụng.
        </p>
